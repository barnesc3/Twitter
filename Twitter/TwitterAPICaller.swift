...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "SWwAAklvcTHzGDuuVhVszW83G", consumerSecret: "wCzR1pXqE543bi6IS4Z4isLq5CJObkPJ3BFSWb3EBuTmzMTDcS")
    var loginSuccess: (() -> ())?
